...
public:		
	...
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, CMD_S_CallScore *pVideoOutCard);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, CMD_S_BankerInfo *pVideoSendCard);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, CMD_S_PassCard *pVideoNotify);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, CMD_S_OutCard *pVideoResult);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, CMD_S_GameConclude *pVideoResult);
