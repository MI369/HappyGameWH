...
VOID CSkinResourceManager::SetSkinResource(const tagSkinRenderInfo & SkinRenderInfo)
{
	...
	//更新资源
	CSkinEdit::m_SkinAttribute.LoadSkinOption();
	CSkinDialog::m_SkinAttribute.LoadSkinOption();
	CSkinHeaderCtrl::m_SkinAttribute.LoadSkinOption();
	CSkinHyperLink::m_SkinAttribute.LoadSkinOption();
