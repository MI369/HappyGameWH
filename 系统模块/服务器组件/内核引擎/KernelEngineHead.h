...
#define EVENT_TCP_NETWORK_FOREGROUND 0x000a								// 网络前后台切换事件
...
static const GUID IID_ITCPSocketEvent = { 0x0501c2de,0x69b1,0x4136,0x00af,0x30,0x2d,0x2d,0x1e,0x35,0x51,0x24 };
#else
#define VER_ITCPSocketEvent INTERFACE_VERSION(1,1)
...
public:
	...
	//网络前后台切换事件
	virtual bool OnEventTCPNetworkForeground(DWORD dwSocketID, bool foreground) = NULL;
};
