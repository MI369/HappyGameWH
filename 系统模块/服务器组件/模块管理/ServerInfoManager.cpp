...
bool CServerInfoManager::LoadPersonalRoomParameter(tagPersonalRoomOption  & pesronalRoomOption, tagPersonalRoomOptionRightAndFee  & personalRoomOptionRightAndFee,  WORD wServerID)
{
	...
	try
	{
		...
		//pesronalRoomOption.lFeeCardOrBeanCount=PlatformDBAide.GetValue_LONGLONG(TEXT("DiamondCount"));
...
//	WriteFileValue(TEXT("Option"), TEXT("FeeCardOrBeanCount"), PersonalRoomOption.lFeeCardOrBeanCount,  szIniFile);
	...
	WriteFileValue(TEXT("Option"), TEXT("MaxCellScore"), (UINT)PersonalRoomOption.lMaxCellScore, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("PersonalRoomTax"), (UINT)PersonalRoomOption.lPersonalRoomTax, szIniFile);
	...
	WriteFileValue(TEXT("Option"), TEXT("BeginFreeTime"), PersonalRoomOption.wBeginFreeTime, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("EndFreeTime"), PersonalRoomOption.wEndFreeTime, szIniFile);
