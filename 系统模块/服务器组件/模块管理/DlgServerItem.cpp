...
bool CDlgServerItem::GetModuleInitParameter(tagGameServerInfo * pGameServerInfo, bool bAutoMode)
{
	...
	UINT uPersonalRuleSize = sizeof(m_ModuleInitParameter.GameServiceOption.cbPersonalRule);
	CopyMemory(m_ModuleInitParameter.GameServiceOption.cbPersonalRule, pGameServerInfo->cbPersonalRule, uPersonalRuleSize);
