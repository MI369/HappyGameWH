...
public:
	CToolTipCtrl m_ToolTipCtrl;   //tip控件
	DECLARE_MESSAGE_MAP()
};
...
public:
	...
	VOID	OnSelChangeGameMode1();
	VOID	OnSelChangeGameMode2();
	VOID	OnSelChangeGameMode3();
	VOID	OnSelChangeGameMode4();
	VOID	OnSelChangeGameMode5();
