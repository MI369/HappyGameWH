...
#define DBR_GR_WRITE_ROOM_TASK_PROGRESS		1700					//推荐约战任务
//////////////////////////////////////////////////////////////////////////////////
//输出信息
...
struct DBR_GR_WritePersonalGameScore
{
	...
	TCHAR							szVideoNumber[LEN_VIDEO_NUMBER];		//视频ID	
	BYTE							cbLoopCount;							//圈数
	int								nGamesNum;								//游戏局数
	BYTE							cbGameMode;								//游戏模式
	BYTE							cbGameoverData[LEN_GAMEOVER_DATA];		//游戏结束时数据
	WORD							wGameoverDataSize;						//实际长度
...
struct DBO_GR_CreateSuccess
{
	...
	BYTE							cbPayMode;								//支付方式 0 房主支付， 1 AA制支付
	BYTE							cbGameMode;							//游戏模式
};
