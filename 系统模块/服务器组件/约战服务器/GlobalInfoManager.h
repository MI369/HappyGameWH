...
typedef CMap<DWORD, DWORD, tagPersonalTableInfo*, tagPersonalTableInfo* &> CMapPersonalTableInfo;
...
public:
	//查找桌子
	tagPersonalTableInfo* SearchTableByID(DWORD dwRoomID);
	//查找桌子
	...
	//添加桌子
	bool AddServerTable(DWORD dwRoomID, tagPersonalTableInfo PersonalTable);
	//移除桌子
