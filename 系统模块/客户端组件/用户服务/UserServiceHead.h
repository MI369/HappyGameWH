...
public:
	...
	//进房间积分
	virtual SCORE GetFirstScore() = NULL;
...
public:
	...
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo, tagCustomFaceInfo & CustomFaceInfo, bool bIsAndroid, SCORE lFScore) = NULL;
...
public:
	...
	virtual bool DeleteUserItem(IClientUserItem * pIClientUserItem)=NULL;
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo, tagCustomFaceInfo & CustomFaceInfo, BYTE cbCompanion, LPCTSTR pszUserNote, bool bIsAndroid, SCORE lFScore) = NULL;
