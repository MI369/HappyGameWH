...
public:
	...
	//进房间积分
	virtual SCORE GetFirstScore() { return m_lFirstScore; }
...
public:
	...
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo, tagCustomFaceInfo & CustomFaceInfo, bool bIsAndroid, SCORE lFScore);
...
public:
	...
	virtual bool DeleteUserItem(IClientUserItem * pIClientUserItem);
	//增加用户
	virtual IClientUserItem * ActiveUserItem(tagUserInfo & UserInfo, tagCustomFaceInfo & CustomFaceInfo, BYTE cbCompanion, LPCTSTR pszUserNote, bool bIsAndroid, SCORE lFScore);
