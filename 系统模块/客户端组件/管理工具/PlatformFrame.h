...
//平台框架
class CPlatformFrame :public CSkinDialog, public IPlatformFrame, public ITCPSocketSink, public IServerListDataSink, IAndroidOperateCenter, public IUserManagerSink, public IChatControlSink, public IClientControlCallback
{
	//变量定义
protected:
...
public:
	...
	IClientControl *				m_pIClientControl;					//控制接口
...
public:
	...
	// 控制信息
	virtual bool OnControlInfo(WORD nMessageID, WORD wTableID, void * pData, WORD nSize);
	// 控制消息
	bool  OnSocketSubUserControl(const void * pData, WORD wDataSize);
	//发送登录
