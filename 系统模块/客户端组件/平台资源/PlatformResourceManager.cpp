...
#define USE_FILE_ZIP
	...
	_sntprintf_s(szIniFile, CountArray(szIniFile), TEXT("%sResource"), CPaintManagerUI::GetInstancePath());
	CPaintManagerUI::SetResourcePath(szIniFile);
	//CPaintManagerUI::SetResourcePath(CPaintManagerUI::GetInstancePath() + TEXT("Resource"));
#ifdef USE_FILE_ZIP
	TCHAR szIniFile_[MAX_PATH] = TEXT("");
	_sntprintf_s(szIniFile_, CountArray(szIniFile_), TEXT("%sResource\\Resource.dll"), CPaintManagerUI::GetInstancePath());
	CPaintManagerUI::SetFileZip(szIniFile_, true);
