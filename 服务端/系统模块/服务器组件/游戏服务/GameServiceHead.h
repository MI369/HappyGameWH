...
#define INDEX_WEBSOCKET				(WORD)(0x4000)						//WebSocket索引
...
public:
	...
	//原先积分
	virtual tagUserScore * GetFormerScore() = NULL;
	//用户规则
...
public:
	...
	virtual TCHAR* GetVideoNumber()=NULL;
	//游戏结束数据
	virtual	void	SetGameoverData(BYTE *byGameoverData)=NULL;
	virtual BYTE*	GetGameoverData() = NULL;
	//属性信息
public:
	//用户性别
...
public:
	...
	//约战房设置密码
	virtual VOID SetPersonalTablePassword(tagRoomPassword *pPassword) = NULL;
	//配置参数
public:
	//自定配置
	virtual VOID * GetCustomRule()=NULL;
...
public:
	...
	//设置锁定
	virtual VOID SetPersonalTableLocked(bool bLocked)=NULL;
	//设置桌主
...
public:
	...
	//结束游戏
	virtual bool ConcludeGame(BYTE cbGameStatus,BOOL bPersonalLoop=false)=NULL;
...
public:
	...
	//发送数据
	virtual bool SendRoomData(IServerUserItem * pIServerUserItem, WORD wSubCmdID) = NULL;
	//发送数据
	virtual bool SendRoomData(IServerUserItem * pIServerUserItem, WORD wSubCmdID, VOID * pData, WORD wDataSize) = NULL;
...
public:
	...
	//坐下动作
	virtual bool PerformSitDownAction(WORD wChairID, IServerUserItem * pIServerUserItem, LPCTSTR lpszPassword=NULL,DWORD dwRoomPwd=0)=NULL;
...
public:
	...
	//获取最大局数
	virtual DWORD  GetDrawCountLimit() = NULL;
	//设置圈数
	virtual void	SetLoopCount(BYTE val) = NULL;
	//获取圈数
	virtual BYTE	GetLoopCount() = NULL;
	//获取游戏模式
	virtual BYTE	GetGameMode() = NULL;
};
...
public:
	...
	//群发数据
	virtual bool SendDataBatchToCheatUser(IServerUserItem * pIServerUserItem, WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize) = NULL;
...
public:
	...
	//取消创建
	virtual VOID CancelCreateTable(DWORD dwUserID, DWORD dwDrawCountLimit, DWORD dwDrawTimeLimit, DWORD dwReason, WORD wTableID,  DWORD dwPersonalRoomID)=NULL;
	//更新桌子
